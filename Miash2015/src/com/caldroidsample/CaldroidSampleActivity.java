...
public class CaldroidSampleActivity extends FragmentActivity {
	...
	private void setCustomResourceForDates() {
		...
		if (caldroidFragment != null) {
			...
			caldroidFragment.setMesInicial(1000); // Jan/2015
			caldroidFragment.setMesFinal(1011); // Dez/2015
		}
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// If activity is created from fresh
			...
			Calendar cal = Calendar.getInstance();
			Log.d("ITALO",cal.get(Calendar.MONTH)+"");
			args.putInt(CaldroidFragment.MONTH, cal.get(Calendar.MONTH) + 1);
			args.putInt(CaldroidFragment.YEAR, cal.get(Calendar.YEAR));
			args.putBoolean(CaldroidFragment.ENABLE_SWIPE, true);//italo
