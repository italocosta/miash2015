...
import com.italorrc.miash2015.R;
...
public class CaldroidFragment extends DialogFragment {
    ...
    /**
     * Customização Miash - Definição de periodo inicial e final do calendario
     * 
     */
    ...
    public int getCurrentVirtualPosition() {
        ...
        Log.d("ITALO",pageChangeListener.getCurrent(currentPage)+" - ATUAL");
    ...
    public void prevMonth() {
    	int mesAtual =  pageChangeListener.getCurrentPage();
    	Log.d("ITALO", mesAtual+"-"+this.getMesInicial());
    	
    	rightArrowButton.setVisibility(View.VISIBLE);
        
        if (mesAtual > this.getMesInicial()){
        	dateViewPager.setCurrentItem(mesAtual - 1);
    	}
    	if (mesAtual == (this.getMesInicial()+1)){
    ...
    public void nextMonth() {
    	int mesAtual =  pageChangeListener.getCurrentPage();
    	Log.d("ITALO", mesAtual+"-"+this.getMesFinal());
    	
    	leftArrowButton.setVisibility(View.VISIBLE);
    	if (mesAtual < this.getMesFinal()){
        	dateViewPager.setCurrentItem(mesAtual + 1);
    	}
    	if (mesAtual == (this.getMesFinal()-1)){
